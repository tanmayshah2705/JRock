...
ResultSet resultSet=statement.executeQuery("select id,name,designation_code,title,date_of_birth,gender,is_indian,basic_salary,pan_number,aadhar_card_number from employee inner join designation on designation_code=designation.code order by employee.name");
int id;
String name;
int designationCode;
String title;
...
{
Connection connection = DAOConnection.getConnection();
PreparedStatement preparedStatement=connection.prepareStatement("select id from employee where aadhar_card_number = ?");
preparedStatement.setString(1,employee.getAadharCardNumber());
ResultSet resultSet=preparedStatement.executeQuery();
if(resultSet.next())
{
resultSet.close();
preparedStatement.close();
throw new DAOException("Aadhar card number: "+employee.getAadharCardNumber()+" exists");
}
resultSet.close();
preparedStatement.close();
preparedStatement=connection.prepareStatement("select id from employee where pan_number = ?");
preparedStatement.setString(1,employee.getPANNumber());
...
{
throw new DAOException(sqlException.getMessage());  ////need to be done
}
}
...
{
throw new DAOException("Invalud employee id : "+employeeId);
}
...
{
Connection connection=DAOConnection.getConnection();
PreparedStatement preparedStatement=connection.prepareStatement("select id,name,designation_code,title,date_of_birth,gender,is_indian,basic_salary,pan_number,aadhar_card_number from employee inner join designation on designation_code=designation.code and id=?");
preparedStatement.setInt(1,actualEmployeeId);
ResultSet resultSet=preparedStatement.executeQuery();
if(resultSet.next()==false)
{
...
{
Connection connection=DAOConnection.getConnection();
PreparedStatement preparedStatement=connection.prepareStatement("select id,name,designation_code,title,date_of_birth,gender,is_indian,basic_salary,pan_number,aadhar_card_number from employee inner join designation on designation_code=designation.code and pan_number=?");
preparedStatement.setString(1,panNumber);
ResultSet resultSet=preparedStatement.executeQuery();
if(resultSet.next()==false)
{
...
{
Connection connection=DAOConnection.getConnection();
PreparedStatement preparedStatement=connection.prepareStatement("select id,name,designation_code,title,date_of_birth,gender,is_indian,basic_salary,pan_number,aadhar_card_number from employee inner join designation on designation_code=designation.code and aadhar_card_number=?");
preparedStatement.setString(1,aadharCardNumber);
ResultSet resultSet=preparedStatement.executeQuery();
if(resultSet.next()==false)
{
